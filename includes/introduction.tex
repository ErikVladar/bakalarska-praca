...
\paragraph{Motivácia a význam práce}
...
\paragraph{Štruktúra práce}

Táto bakalárska práca je rozdelená do siedmich kapitol, ktoré pokrývajú teóriu, analýzu, návrh riešenia, implementáciu a výsledky systému pre detekciu rukou písaných nomenklátorových šifrovacích kľúčov.
