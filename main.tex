...
\FEItitleEn{Detection of components of historical handwritten substitution cipher keys using artificial intelligence}
...
\FEIkeywordsEn{historical ciphers, handwritten documents, object detection, artificial intelligence, image processing, document segmentation, YOLO, binarization, data augmentation}
...
\includepdf[pages=-]{includes/file-19.pdf}
